// File that contains the declarations for the matrix-vector operation functions in matvecops.cpp
...
/* Function that performs matrix-vector multiplication given a sparse CSR-matrix
   and an input vector. */
